...
async function runJobFlow() {
  ...
  // Note: WORK_STARTED doesn't change state, skipping for this demo
  // In real system, this would update metadata but not trigger state transition
  ...
  // Note: PAYMENT_RECEIVED doesn't change state, skipping for this demo
  // In real system, this would update payment metadata but not trigger state transition
